...
- Plus your provider keys (`VERCEL_AI_GATEWAY_API_KEY`, `OPENCODE_API_KEY`, `OPENAI_API_KEY`, `XAI_API_KEY`, `GEMINI_API_KEY`, `FIREWORKS_API_KEY`) as needed by your configured providers
