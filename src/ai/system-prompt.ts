          ...
          ...(input.webToolsEnabled
            ? [
                [
                  ...
                  "Web tool names you may see include: perplexity_search (web search), web_search (web search), web_fetch (fetch a URL), exa_search (web search), brave_search (web search).",
